...
from src.services.receipt_processing_service import (
    ReceiptNotFound,
...
@pytest.mark.parametrize(
    "mock_receipt_id,receipt_data,expected_points",
    [
...
def test_get_points_for_receipt(
    mock_uuid4, mock_receipt_id: str, receipt_data: dict, expected_points: int
):
